...
//         .then(function (data) {
//         var content = data.response; // Extract content from response
...
var createChatLi = function (message, className) {
    ...
    var chatLi = document.createElement("li");
    chatLi.classList.add("chat", "".concat(className));
    var chatContent = className === "outgoing" ? "<p></p>" : "<span class=\"material-symbols-outlined\">smart_toy</span><p style=\"text-align:left;\"></p>";
    chatLi.innerHTML = chatContent;
    chatLi.querySelector("p").textContent = message;
    return chatLi; // return chat <li> element
};
